...
class QuotedEasy_AI_Readiness_Core {
	 ...
	 * Hook registrar.
	 *
	 * @var QuotedEasy_AI_Readiness_Loader
	 */
	protected $loader;
	 ...
	 * Load translations.
	 *
	 * Hooked on `init` (not `plugins_loaded`). QuotedEasy_AI_Readiness_Core itself is
	...
	private function define_public_hooks() {
		...
		// "Powered by QuotedEasy AI Readiness" credit — opt-in. The hook is only registered
		...
		// in auto mode. See QuotedEasy_AI_Readiness_Schema::conflicting_seo_plugin().
